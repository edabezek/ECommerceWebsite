...
var KTDatatablesServerSide = function () {
    var e, t, n = () => {
        document.querySelectorAll('[data-kt-docs-table-filter="delete_row"]').forEach((t => {
            t.addEventListener("click", (function (t) {
                t.preventDefault();
                const n = t.target.closest("tr").querySelectorAll("td")[1].innerText;
                Swal.fire({
        ...
        o = function () {
            const t = document.querySelector("#kt_datatable_example_1"),
                ...
                o = document.querySelector('[data-kt-docs-table-select="delete_selected"]');
            n.forEach((e => {
        ...
        a = function () {
            const e = document.querySelector("#kt_datatable_example_1"),
                ...
                o = document.querySelector('[data-kt-docs-table-select="selected_count"]'),
                a = e.querySelectorAll('tbody [type="checkbox"]');
            let c = !1,
                r = 0;
            a.forEach((e => {
                e.checked && (c = !0, r++)
            })), c ? (o.innerHTML = r, t.classList.add("d-none"), n.classList.remove("d-none")) : (t.classList.remove("d-none"), n.classList.add("d-none"))
        };
    return {
        init: function () {
            e = $("#kt_datatable_example_1").DataTable({
                ...
                columnDefs: [{
                    ...
                    render: function (e, t, n) {
                        return `<img src="${hostUrl}media/svg/card-logos/${n.CreditCardType}.svg" class="w-35px me-3" alt="${n.CreditCardType}">` + e
                    }
                }, {
                    targets: -1,
                    data: null,
            ...
            })), o(), t = document.querySelectorAll('[data-kt-docs-table-filter="payment_type"] [name="payment_type"]'), document.querySelector('[data-kt-docs-table-filter="filter"]').addEventListener("click", (function () {
                let n = "";
                t.forEach((e => {
                    e.checked && (n = e.value), "all" === n && (n = "")
                })), e.search(n).draw()
            })), n(), document.querySelector('[data-kt-docs-table-filter="reset"]').addEventListener("click", (function () {
